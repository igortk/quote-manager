...
func (x *Error) Reset() {
	*x = Error{}
	if protoimpl.UnsafeEnabled {
		mi := &file_message_error_proto_msgTypes[0]
...
var file_message_error_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x35, 0x0a, 0x05,
...
var file_message_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_message_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_message_error_proto_msgTypes,
	}.Build()
